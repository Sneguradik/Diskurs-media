(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    function WPeE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "FeedResolverService", function () {
        return FeedResolverService;
      });
      /* harmony import */
      ...
      var _api_schemas_feed_feed_order_enum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      function fetchArticlesWithTopics$(page, topicsService) {
        ...
        page.content.forEach(function (article) {
          if (article.topics.length > 0) {
            if (!topicsIds.includes(article.topics[0])) {
              ...
              topics.push(topicsService.getOne$(article.topics[0]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function () {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(null);
              })));
            }
          }
        });
        return page.content.length > 0 ? Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["combineLatest"])(topics).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["defaultIfEmpty"])([]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (topicsRet) {
          var content = [];
          page.content.forEach(function (article) {
            if (article.topics.length > 0) {
        ...
        })) : Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(Object.assign(Object.assign({}, page), {
          content: []
        }));
      }

      var FeedResolverService = /*#__PURE__*/function () {
        function FeedResolverService(feedService, platformService, topicsService, usersService) {
          _classCallCheck(this, FeedResolverService);
        ...
        return _createClass(FeedResolverService, [{
          key: "resolve",
          value: function resolve(route) {
            var _this = this;

            if (this.platformService.isServer) {
              var path = route.pathFromRoot.map(function (ars) {
                return ars.url.map(function (segment) {
              ...
              if (path.includes('/all')) {
                return this.feedService.feedRequest$({
                  order: _api_schemas_feed_feed_order_enum__WEBPACK_IMPORTED_MODULE_3__["FeedOrderEnum"].TIME,
                  page: 0
                }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (article) {
                  return fetchArticlesWithTopics$(article, _this.topicsService);
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (page) {
                  return page.content;
                }));
              }
              ...
              if (path.includes('/company/') || path.includes('/user/')) {
                return this.usersService.getSingle$(route.params['id']).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (user) {
                  return _this.feedService.feedRequest$({
                    order: _api_schemas_feed_feed_order_enum__WEBPACK_IMPORTED_MODULE_3__["FeedOrderEnum"].TIME,
                    author: user.meta.id,
                    page: 0
                  });
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (article) {
                  return fetchArticlesWithTopics$(article, _this.topicsService);
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (page) {
                  return page.content;
                }));
      ...
      FeedResolverService.ɵfac = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵngDeclareFactory"]({
        minVersion: "12.0.0",
        version: "12.2.17",
        ngImport: _angular_core__WEBPACK_IMPORTED_MODULE_0__,
        type: FeedResolverService,
        deps: [{
          token: _api_routes_feed_service__WEBPACK_IMPORTED_MODULE_4__["FeedService"]
        }, {
          token: _platform_service__WEBPACK_IMPORTED_MODULE_5__["PlatformService"]
        }, {
      ...
      FeedResolverService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵngDeclareInjectable"]({
        minVersion: "12.0.0",
        version: "12.2.17",
        ngImport: _angular_core__WEBPACK_IMPORTED_MODULE_0__,
        type: FeedResolverService,
    ...
    /***/
    function t08Q(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EventCurrencyEnum", function () {
        return EventCurrencyEnum;
      });
    ...
    /***/
    function x8C0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EventFiltersEnum", function () {
        return EventFiltersEnum;
      });
