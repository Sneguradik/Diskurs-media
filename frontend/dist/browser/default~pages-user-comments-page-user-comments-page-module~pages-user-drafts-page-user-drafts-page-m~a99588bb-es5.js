(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-user-comments-page-user-comments-page-module~pages-user-drafts-page-user-drafts-page-m~a99588bb"], {
    /***/
    "5TyJ":
    /*!***********************************************************!*\
    ...
    /***/
    function n3P(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _shared_classes_abstract_component_class__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var _app_store_user_stats_user_stats_state__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! @app/store/user-stats/user-stats.state */
      "wAu3");
      /* harmony import */
      ...
      var _app_services_session_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! @app/services/session.service */
      "qh/L");
      /* harmony import */


      var _api_routes_feed_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! @api/routes/feed.service */
      "R237");
      /* harmony import */


      var _api_routes_companies_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! @api/routes/companies.service */
      "qPE0");
      /* harmony import */


      var _layout_dynamic_meta_tags_dynamic_meta_tags_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! @layout/dynamic-meta-tags/dynamic-meta-tags.service */
      "xAOu");
      /* harmony import */


      var _api_routes_events_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! @api/routes/events.service */
      "3Gor");
      /* harmony import */


      var _api_routes_jobs_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! @api/routes/jobs.service */
      "YWUd");
      /* harmony import */


      var _layout_shared_services_header_stats_sync_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      ...
      var _app_services_permission_permission_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! @app/services/permission/permission.service */
      "ZG4Y");
      /* harmony import */


      var _shared_services_notification_update_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! @shared/services/notification-update.service */
      "ND82");
      /* harmony import */


      var _shared_ui_info_header_info_header_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ../../../shared/ui/info-header/info-header.component */
      "zwVY");
      /* harmony import */


      var _shared_components_action_menu_action_menu_user_action_menu_user_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ../../../shared/components/action-menu/action-menu-user/action-menu-user.component */
      "YNL8");
      /* harmony import */
      ...
      var _shared_pipes_person_name_pipe__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      ...
      var UserHeaderComponent = /*#__PURE__*/function (_shared_classes_abstr) {
        function UserHeaderComponent(usersService, sessionService, feedService, companiesService, dynamicMetaTagsService, eventsService, jobsService, headerStatsSyncService, router, perms, notificationUpdateService, activatedRoute) {
          var _this;

          _classCallCheck(this, UserHeaderComponent);

          _this = _callSuper(this, UserHeaderComponent);
          ...
          _this.headerStatsSyncService = headerStatsSyncService;
          _this.router = router;
          _this.perms = perms;
          _this.notificationUpdateService = notificationUpdateService;
          _this.activatedRoute = activatedRoute;
          _this.commentCount$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["ReplaySubject"](1);
          _this.draftCount$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["ReplaySubject"](1);
          _this.promotedCount$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["ReplaySubject"](1);
          _this.isMe$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["ReplaySubject"](1);
          _this.unreadCount = 0;
          return _this;
        }

        _inherits(UserHeaderComponent, _shared_classes_abstr);

        return _createClass(UserHeaderComponent, [{
          key: "ngOnInit",
          ...
          value: function ngOnDestroy() {
            ...
            _superPropGet(UserHeaderComponent, "ngOnDestroy", this, 3)([]);
          }
        }, {
          key: "setCoreParams",
          value: function setCoreParams() {
            var _this2 = this;

            this.idOrName$ = this.activatedRoute.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () {
              var urlArray = _this2.router.url.split('/');

              _this2.url = '/' + urlArray[1] + '/' + urlArray[2];
            }), Object(_shared_utils_id_map_operator__WEBPACK_IMPORTED_MODULE_7__["idMap"])());
            this.user$ = this.idOrName$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (id) {
              return _this2.usersService.getSingle$(id);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () {
              return _this2.getMainData();
            }));
            this.id$ = this.user$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (user) {
              return user.meta.id;
            }));
            this.me$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])([this.idOrName$, this.sessionService.user$]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (_ref) {
          ...
          value: function setParams() {
            ...
            this.id$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (id) {
              return _this3.usersService.commentCount$(id);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngOnDestroy$)).subscribe(this.commentCount$);
            var pageId$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])([this.sessionService.user$, this.id$]);
            pageId$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (_ref3) {
              var _ref4 = _slicedToArray(_ref3, 2),
                  me = _ref4[0],
                  id = _ref4[1];

              return me.meta.id === id;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (_ref5) {
              var _ref6 = _slicedToArray(_ref5, 2),
                  id = _ref6[1];

              return _this3.feedService.count$({
                author: id,
                stage: [_api_schemas_article_publication_stage_enum__WEBPACK_IMPORTED_MODULE_5__["PublicationStageEnum"].DRAFT]
              });
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngOnDestroy$)).subscribe(this.draftCount$);
            this.id$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (author) {
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])([_this3.feedService.count$({
                bookmark: true,
                bookmarked: author
              }), _this3.eventsService.getBookmarked$(author, 0), _this3.jobsService.getBookmarked$(author, 0)]);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (_ref7) {
              var _ref8 = _slicedToArray(_ref7, 3),
                  articles = _ref8[0],
                  events = _ref8[1],
                  jobs = _ref8[2];

              return articles + events.total + jobs.total;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngOnDestroy$)).subscribe(this.promotedCount$);
            this.user$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngOnDestroy$)).subscribe(function (user) {
              var _a;

              _this3.authorInfo = user;
              _this3.isMe = _this3.sessionService.loggedIn$.value && user.meta.id === _this3.sessionService.userId;

              if (user.info.company) {
                _this3.headerStatsSyncService.subEvent$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (_ref9) {
                  var _ref10 = _slicedToArray(_ref9, 2),
                      type = _ref10[0],
                      id = _ref10[1];

                  return type === 'company' && id === _this3.authorInfo.meta.id;
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_ref11) {
                  var _ref12 = _slicedToArray(_ref11, 3),
                      status = _ref12[2];

                  return _this3.authorInfo = Object.assign(Object.assign({}, _this3.authorInfo), {
                    subscribers: Object.assign(Object.assign({}, _this3.authorInfo.subscribers), {
                      you: status
                    })
                  });
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(_this3.ngOnDestroy$)).subscribe();
              }

              if (user.info.company.isCompany || ((_a = user.roles) === null || _a === void 0 ? void 0 : _a.includes('ROLE_SUPERUSER'))) {
                _this3.jobCount$ = _this3.companiesService.jobCountNew$(user.meta.id);
                _this3.eventCount$ = _this3.companiesService.eventCount$(user.meta.id);
              } else {
                _this3.jobCount$ = null;
                _this3.eventCount$ = null;
              }

              if (_this3.isMe) {
                _this3.notificationUpdateService.update();
              }
            });
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])([this.user$, this.sessionService.user$]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (_ref13) {
              var _ref14 = _slicedToArray(_ref13, 2),
                  page = _ref14[0],
                  user = _ref14[1];

              return (page === null || page === void 0 ? void 0 : page.meta.id) === (user === null || user === void 0 ? void 0 : user.meta.id);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngOnDestroy$)).subscribe(function (isMe) {
              _this3.isMe$.next(isMe);
            });
          }
        }, {
          key: "getMainData",
          value: function getMainData() {
            var user = this.activatedRoute.snapshot.data.data;
            this.dynamicMetaTagsService.metaInfo$.next({
              title: user.info.username,
              tags: [{
                property: 'og:title',
                content: user.info.username
              }, {
                name: 'description',
                content: user.info.bio
              }, {
                property: 'og:description',
                content: user.info.bio
              }, {
                property: 'og:image',
                content: user.info.picture
              }, {
                property: 'og:url',
          ...
          value: function subFunc() {
            this.usersService.subscribe$(this.authorInfo.meta.id, this.authorInfo.subscribers.you).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngOnDestroy$)).subscribe();
            this.authorInfo = Object.assign(Object.assign({}, this.authorInfo), {
              subscribers: Object.assign(Object.assign({}, this.authorInfo.subscribers), {
      ...
      }(_shared_classes_abstract_component_class__WEBPACK_IMPORTED_MODULE_4__["AbstractComponent"]);

      UserHeaderComponent.ɵfac = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵngDeclareFactory"]({
        minVersion: "12.0.0",
        version: "12.2.17",
        ...
        deps: [{
          ...
          token: _app_services_session_service__WEBPACK_IMPORTED_MODULE_11__["SessionService"]
        }, {
          token: _api_routes_feed_service__WEBPACK_IMPORTED_MODULE_12__["FeedService"]
        }, {
          token: _api_routes_companies_service__WEBPACK_IMPORTED_MODULE_13__["CompaniesService"]
        }, {
          token: _layout_dynamic_meta_tags_dynamic_meta_tags_service__WEBPACK_IMPORTED_MODULE_14__["DynamicMetaTagsService"]
        }, {
          token: _api_routes_events_service__WEBPACK_IMPORTED_MODULE_15__["EventsService"]
        }, {
          token: _api_routes_jobs_service__WEBPACK_IMPORTED_MODULE_16__["JobsService"]
        }, {
          token: _layout_shared_services_header_stats_sync_service__WEBPACK_IMPORTED_MODULE_17__["HeaderStatsSyncService"]
        }, {
          token: _angular_router__WEBPACK_IMPORTED_MODULE_18__["Router"]
        }, {
          token: _app_services_permission_permission_service__WEBPACK_IMPORTED_MODULE_19__["PermissionService"]
        }, {
          token: _shared_services_notification_update_service__WEBPACK_IMPORTED_MODULE_20__["NotificationUpdateService"]
        }, {
          token: _angular_router__WEBPACK_IMPORTED_MODULE_18__["ActivatedRoute"]
        }],
        target: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵFactoryTarget"].Component
      });
      UserHeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵngDeclareComponent"]({
        minVersion: "12.0.0",
        version: "12.2.17",
        type: UserHeaderComponent,
        ...
        directives: [{
          ...
          type: _angular_router__WEBPACK_IMPORTED_MODULE_18__["RouterLinkWithHref"],
          ...
          type: _angular_router__WEBPACK_IMPORTED_MODULE_18__["RouterLinkActive"],
          selector: "[routerLinkActive]",
          inputs: ["routerLinkActiveOptions", "routerLinkActive"],
          exportAs: ["routerLinkActive"]
        }],
        pipes: {
          "personName": _shared_pipes_person_name_pipe__WEBPACK_IMPORTED_MODULE_25__["PersonNamePipe"],
          "async": _angular_common__WEBPACK_IMPORTED_MODULE_24__["AsyncPipe"],
          "translate": _ngx_translate_core__WEBPACK_IMPORTED_MODULE_26__["TranslatePipe"]
        }
      });
      Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_ngxs_store__WEBPACK_IMPORTED_MODULE_8__["Select"])(_app_store_user_stats_user_stats_state__WEBPACK_IMPORTED_MODULE_9__["USER_STATS_STATE_TOKEN"])], UserHeaderComponent.prototype, "stats$", void 0);
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵngDeclareClassMetadata"]({
        ...
        ctorParameters: function ctorParameters() {
          return [{
            ...
            type: _app_services_session_service__WEBPACK_IMPORTED_MODULE_11__["SessionService"]
          }, {
            type: _api_routes_feed_service__WEBPACK_IMPORTED_MODULE_12__["FeedService"]
          }, {
            type: _api_routes_companies_service__WEBPACK_IMPORTED_MODULE_13__["CompaniesService"]
          }, {
            type: _layout_dynamic_meta_tags_dynamic_meta_tags_service__WEBPACK_IMPORTED_MODULE_14__["DynamicMetaTagsService"]
          }, {
            type: _api_routes_events_service__WEBPACK_IMPORTED_MODULE_15__["EventsService"]
          }, {
            type: _api_routes_jobs_service__WEBPACK_IMPORTED_MODULE_16__["JobsService"]
          }, {
            type: _layout_shared_services_header_stats_sync_service__WEBPACK_IMPORTED_MODULE_17__["HeaderStatsSyncService"]
          }, {
            type: _angular_router__WEBPACK_IMPORTED_MODULE_18__["Router"]
          }, {
            type: _app_services_permission_permission_service__WEBPACK_IMPORTED_MODULE_19__["PermissionService"]
          }, {
            type: _shared_services_notification_update_service__WEBPACK_IMPORTED_MODULE_20__["NotificationUpdateService"]
          }, {
    ...
    "KDmQ":
    /*!*************************************************!*\
      !*** ./src/app/shared/utils/id-map.operator.ts ***!
      \*************************************************/

    /*! exports provided: idMap */

    /***/
    function KDmQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "idMap", function () {
        return idMap;
      });
      /* harmony import */
    ...
    "PMU/":
    /*!****************************************************************!*\
      !*** ./src/app/modules/user/user-header/user-header.module.ts ***!
      \****************************************************************/

    /*! exports provided: UserHeaderModule */

    /***/
    function PMU_(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UserHeaderModule", function () {
        return UserHeaderModule;
      });
      /* harmony import */
      ...
      var _user_header_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _shared_ui_info_header_info_header_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var UserHeaderModule = /*#__PURE__*/_createClass(function UserHeaderModule() {
        _classCallCheck(this, UserHeaderModule);
      });

      UserHeaderModule.ɵfac = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵngDeclareFactory"]({
        minVersion: "12.0.0",
        version: "12.2.17",
        ngImport: _angular_core__WEBPACK_IMPORTED_MODULE_0__,
        type: UserHeaderModule,
        deps: [],
        target: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵFactoryTarget"].NgModule
      });
      UserHeaderModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵngDeclareNgModule"]({
        minVersion: "12.0.0",
        version: "12.2.17",
        ngImport: _angular_core__WEBPACK_IMPORTED_MODULE_0__,
        type: UserHeaderModule,
        declarations: [_user_header_component__WEBPACK_IMPORTED_MODULE_2__["UserHeaderComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _shared_ui_shared_ui_module__WEBPACK_IMPORTED_MODULE_3__["SharedUiModule"], _shared_pipes_shared_pipes_module__WEBPACK_IMPORTED_MODULE_4__["SharedPipesModule"], _shared_ui_info_header_info_header_module__WEBPACK_IMPORTED_MODULE_5__["InfoHeaderModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"], _shared_modules_svg_svg_module__WEBPACK_IMPORTED_MODULE_8__["SvgModule"], _shared_components_shared_components_module__WEBPACK_IMPORTED_MODULE_9__["SharedComponentsModule"]],
        exports: [_user_header_component__WEBPACK_IMPORTED_MODULE_2__["UserHeaderComponent"]]
      });
      UserHeaderModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵngDeclareInjector"]({
        minVersion: "12.0.0",
        version: "12.2.17",
        ngImport: _angular_core__WEBPACK_IMPORTED_MODULE_0__,
        type: UserHeaderModule,
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _shared_ui_shared_ui_module__WEBPACK_IMPORTED_MODULE_3__["SharedUiModule"], _shared_pipes_shared_pipes_module__WEBPACK_IMPORTED_MODULE_4__["SharedPipesModule"], _shared_ui_info_header_info_header_module__WEBPACK_IMPORTED_MODULE_5__["InfoHeaderModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateModule"].forChild(), _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"], _shared_modules_svg_svg_module__WEBPACK_IMPORTED_MODULE_8__["SvgModule"], _shared_components_shared_components_module__WEBPACK_IMPORTED_MODULE_9__["SharedComponentsModule"]]]
      });
...
//# sourceMappingURL=default~pages-user-comments-page-user-comments-page-module~pages-user-drafts-page-user-drafts-page-m~a99588bb-es5.js.map